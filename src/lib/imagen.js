...
async function generarImagen({ participacionId, numero, serie, sorteo, importe, nombre, decimoId, baseUrl }) {
  ...
  <svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="80" y="140" font-family="system-ui" font-size="20" fill="#bfdbfe">Participación verificable</text>
    ...
    <text x="80" y="510" font-family="system-ui" font-size="56" font-weight="bold" fill="#4ade80">${importe.toFixed(2)} €</text>

    <text x="80" y="570" font-family="system-ui" font-size="22" fill="#94a3b8">PARTICIPANTE</text>
    <text x="80" y="620" font-family="system-ui" font-size="36" font-weight="bold" fill="#ffffff">${nombre || 'Anónimo'}</text>

    <text x="80" y="700" font-family="system-ui" font-size="16" fill="#64748b">Escanea para verificar la cadena</text>
  </svg>`;
